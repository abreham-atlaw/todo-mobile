...
class ColorsConfigs {
  static const Color primary = Color.fromARGB(255, 104, 0, 111);
  static const Color primaryLight = Color.fromARGB(255, 250, 193, 255);
  ...
  static const Color light = Color.fromARGB(255, 248, 249, 254);
  static const Color grey = Color.fromARGB(255, 104, 104, 104);
  static const Color danger = Color.fromARGB(255, 186, 0, 0);
...
class SpacingConfigs {
  ...
  static const double spacing4_5 = spacing4 * 1.15;
